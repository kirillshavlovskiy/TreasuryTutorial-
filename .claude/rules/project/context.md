...
- [x] Add Sigma Task 02 (E02 — Five Currency Carry Book) at `/test/tasks/02`: unhedged do-nothing carry @ Tf=12m for EUR · GBP · PLN · MXN · JPY (±5%). Task 02 seed only — Task 01 book unchanged. Forecast on every CCY is NWC + profit (collections) + expenditures (payout) + debt (EUR/MXN/JPY amortize inside Tf), with MoM NWC/revenue/opex growth. Overlay lab: long high-yield MXN (6.19%) vs short low-yield JPY (0.45%); GBP slight EARN, EUR PAY, PLN near-USD. Persist slot `taskId=02`.
